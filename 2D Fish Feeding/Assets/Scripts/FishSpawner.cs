...
public class FishSpawner : MonoBehaviour
{
    ...
    public GameObject spawnPredatorThree;
    ...
    private void Start()
    {
        ...
        InvokeRepeating("spawnJellyFish", Random.Range(1, 3), Random.Range(5, 12));
        ...
        InvokeRepeating("spawnPredatorB", Random.Range(10, 12), Random.Range(16, 26));
   ...
   private void spawnPreyLeftTwo()
    ...
    private void spawnPredatorB()
    {
        Instantiate(spawnPredatorThree, new Vector2(-10f, 0), Quaternion.identity);
    }
